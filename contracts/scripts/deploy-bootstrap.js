...
async function main() {
  console.log("🌈 Arc Token - Bootstrap Launch ($500 Budget)\n");
  ...
  console.log("🚀 Deploying simplified Arc Token for bootstrap...\n");
  ...
  const deployerBalance = await arcToken.balanceOf(deployer.address);
  ...
  console.log("Total Supply:  ", hre.ethers.formatEther(totalSupply), "ARC");
  console.log("Your Balance:  ", hre.ethers.formatEther(deployerBalance), "ARC");
  console.log("");

  console.log("=" .repeat(60));
  console.log("💰 BOOTSTRAP DISTRIBUTION PLAN");
  console.log("=" .repeat(60));
  console.log("Keep in deployer: 850M ARC (85%) - Treasury");
  console.log("Prepare for sale: 100M ARC (10%) - Public");
  console.log("For liquidity:    50M ARC (5%)  - PancakeSwap");
  console.log("");
  console.log("Total in wallet:  1B ARC (everything!)");
  console.log("");
  ...
  console.log("   C. Paste ARC address:", tokenAddress);
  console.log("   D. Add: 50,000,000 ARC + ~$400 worth of BNB");
  console.log("   E. Confirm transaction");
  console.log("");
  console.log("   Price calculation:");
  console.log("   50M ARC + $400 BNB = $0.000008 per ARC");
  ...
  console.log("   Twitter: 🌈 $ARC is LIVE!");
  ...
  const deploymentInfo = {
    ...
    bootstrap: {
      totalSupply: "1,000,000,000 ARC",
      deployerBalance: "1,000,000,000 ARC",
      recommendedLiquidity: "50M ARC + $400 BNB",
      initialPrice: "$0.000008 per ARC",
