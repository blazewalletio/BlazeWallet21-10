        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-background-secondary rounded-2xl border border-gray-200/50 pointer-events-auto"
            >
              {/* Header */}
              ...
              <div className="p-6 space-y-6">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mb-4">
                            ...
                            <div className="text-sm text-text-tertiary">{plan.description}</div>
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="text-sm text-text-tertiary">APY</div>
                          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full px-4 py-4 bg-gray-100 rounded-xl border border-gray-200 focus:border-orange-500 focus:outline-none text-xl"
                    />
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                      <span className="text-text-tertiary">BLAZE</span>
                      <button
                ...
                {amount && parseFloat(amount) > 0 && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <div className="text-sm text-text-tertiary mb-1">Yearly Rewards</div>
                        <div className="text-2xl font-bold text-orange-400">
                          +{calculateRewards().toFixed(2)} BLAZE
                        </div>
                      </div>
                      <div>
                        <div className="text-sm text-text-tertiary mb-1">USD Value (est.)</div>
                ...
                <div className="bg-gray-100/50 rounded-xl p-6 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-text-secondary">Earn passive income in BLAZE</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-green-400 text-xs">✓</span>
                      </div>
                      <span className="text-text-secondary">Compound rewards automatically</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-green-400 text-xs">✓</span>
                      </div>
                      <span className="text-text-secondary">Vote on governance proposals</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-green-400 text-xs">✓</span>
                      </div>
                      <span className="text-text-secondary">Unlock premium features</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={onClose}
                    className="flex-1 py-4 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors"
                  >
                    Cancel
                  </button>
                  <button
